        ...
        <div className="md:col-span-1">
          <div className="game-card sticky top-24">
            ...
            <p className="text-gray-400 mb-8">
              Have questions about Snake Block Breaker? We'd love to hear from
              you!
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">{companyPhone||""}</p>
                  <p className="text-sm text-gray-400">Mon-Fri, 9AM-5PM GMT+1</p>
                </div>
              </div>
        ...
        <div className="md:col-span-2">
          <div className="game-card">
            ...
            <div className="mt-6 p-4 bg-gray-800/30 rounded-lg border border-gray-700 text-center">
              <p className="text-sm text-gray-400">
                ⚡ For urgent matters, please reach out via our Discord server
                for faster response.
              </p>
            </div>
          </div>
